...
//    }
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        final Boolean isAppRuning=false;//intent.getBooleanExtra("isAppRunning",false);

        final MessageDao message = intent.getParcelableExtra("message");
        String host_name =  message.getIncomingdisplay_name();
