...
export default class ProfileDetails extends React.Component {
    ...
    option2Click = (e) => {
        ...
        if (this.props.route.params.from == "Chat") {
        ...
        else if (this.props.route.params.OnlineUser == "OnlineUser") {
            const data = this.props.route.params.profile_id;
        ...
        else if (this.props.MostActiveUser == "MostActiveUser") {
            ...
            this.props.route.params.backFromProfile(this.state.entries.profile_id);
        }
        // Adding the elseif condition for the online user
        // this._menu.hide();  //vinod
        this.setState({ canShowMenu: false })
    };
    option3Click = () => {
        this._reportProfile()
        ...
        return (
            ...
            <View style={{ position: 'absolute', zIndex: 10, top: 5, width: '100%' }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20, paddingVertical: 10 }}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.goBack(null)} style={{ borderRadius: 20, backgroundColor: '#23232399', padding: 5 }}>
                        <Icon name="arrow-left" size={30} color="#fff" />
                    </TouchableOpacity>

                    <View style={{ borderRadius: 20, backgroundColor: '#23232399', padding: 5 }}>
                        <Menu
                            ...
                            ref={this.setMenuRef}>
                            <Menu.Item title={"Call"} onPress={this.option1Click} />
                            <Menu.Item title={"Message"} onPress={this.option2Click} />
                            <Menu.Item title={"Report"} onPress={this.option3Click} />
                        </Menu>
                    </View>
                </View>
            </View >
