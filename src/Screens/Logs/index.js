...
export default class Logs extends React.Component {
  ...
  tabchange(tabIndex) {
    console.log('tabChange=====>', tabIndex);
    try {
      if (this.tabView) {
        this.tabView.goToPage(tabIndex - 1);
        this.setState({selTab: tabIndex}, () => {
          this.props.logTab(tabIndex);
        });
      }
    } catch (error) {
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    zIndex: this.state.selTab == 1 ? 5 : 0,
                    marginRight: -5,
                    flex: 1,
                    borderRadius: 20,
                    backgroundColor:
                      this.state.selTab == 1 ? '#232323' : 'lightgrey',
                  }}>
                  <Text
                    style={{
                      color: '#fff',
                ...
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    flexDirection: 'row',
                    paddingHorizontal: 15,
                    zIndex: this.state.selTab == 2 ? 5 : 0,
                    marginLeft: -5,
                    flex: 1,
                    borderRadius: 20,
                    backgroundColor:
                      this.state.selTab == 2 ? '#232323' : 'lightgrey',
                  }}>
                  <Text
                    style={{
                      color: '#fff',
...
//           flexDirection: 'row',
//           paddingHorizontal: 15,
//           zIndex: selTabC == 1 ? 5 : 0,
//           marginRight: -5,
//           flex: 1,
//           borderRadius: 20,
//           backgroundColor: selTabC == 1 ? '#232323' : 'lightgrey',
//         }}>
//         <Text
//           style={{
//             color: '#fff',
...
//           flexDirection: 'row',
//           paddingHorizontal: 15,
//           zIndex: selTabC == 2 ? 5 : 0,
//           marginLeft: -5,
//           flex: 1,
//           borderRadius: 20,
//           backgroundColor: selTabC == 2 ? '#232323' : 'lightgrey',
//         }}>
//         <Text
//           style={{
//             color: '#fff',
