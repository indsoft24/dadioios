...
export default class MyPreference extends React.Component {
    ...
    goBack() {
        this.props.route.params.backFromBasicInfo("home");
                        ...
                        <View style={{ flex: 1, padding: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', height: 40 }}>
                                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <View style={{ paddingHorizontal: 10, paddingVertical: 2, margin: 5, backgroundColor: R.colors.cyan, borderRadius: 50 }}>
                                        <Icon name="gender-male" size={15} color="#232323" />
                                    </View>
                                </View>
                                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <View style={{ paddingHorizontal: 10, paddingVertical: 2, margin: 5, backgroundColor: 'pink', borderRadius: 50 }}>
                                        <Icon name="gender-female" size={15} color="#232323" />
                                    </View>
                                </View>
                            ...
                            <View style={{ height: 60, width: '100%', marginVertical: 15 }} >
                                <Text style={{ fontSize: 18, fontWeight: 'bold', padding: 5, color: '#232323' }}>
                                    Age Range {this.state.rangeLow2} to {this.state.rangeHigh2}
                                </Text>
                                <Slider
                                    maximumValue={70}
                                    minimumValue={18}
                                    ...
                                    onValueChange={value => {
                                        console.log(value);
                                        this.setState({ rangeLow2: value[0], rangeHigh2: value[1] })
                                    }}
                                />
                                {/* <RangeSlider
                                    style={{ height: 60 }}
                            ...
                            <View style={{ height: 60, width: '100%', marginVertical: 15 }} >
                                <Text style={{ fontSize: 18, fontWeight: 'bold', padding: 5, color: '#232323' }}>
                                    Distance Range (KMs) {this.state.rangeLow1} to {this.state.rangeHigh1} {this.state.rangeHigh1 == "5000" ? "+" : ""}
                                </Text>
                                ...
                                <Slider
                                    ...
                                    onValueChange={value => {
                                        console.log(value);
                                        this.setState({ rangeHigh1: value })
                                    }}
                                />
                                {/* <RangeSlider
                                        style={{ height: 60 }}
                                ...
                                <View style={{ flexDirection: 'row', height: 40 }}>
                                    ...
                                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', padding: 5 }}>
                                        <TouchableOpacity onPress={() => this.setState({ offline: !this.state.offline })}>
                                            <Icon name={this.state.offline ? "checkbox-blank-outline" : " checkbox-marked "} size={25} color="#232323" />
                                        </TouchableOpacity>
                                        <Text style={{ fontSize: 16, paddingHorizontal: 5, color: '#232323' }}>
                                            Offline
                                        </Text>
