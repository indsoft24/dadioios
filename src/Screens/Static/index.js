...
export default class Static extends React.Component{
    ...
    componentDidMount(){
        console.log("static..............",this.props.route.params.data);
        this.setState({title:this.props.route.params.data.name})
    }
    ...
    contactUsWebService(){
        Utils.ApiPost(`${R.constants.Api.contactUs}${this.props.route.params.userId}&contactus_subject=${this.state.contactSubject}&contactus_message=${this.state.contactMessage}`,response=(data)=>{
    ...
    renderContent(){
        return(
            <KeyboardAwareScrollView style={{flex:1,backgroundColor:'#fff'}}>
                {this.props.route.params.data.id!=3 && <View style={{margin: 10,}}>
                    <HTML
                    contentWidth={Dimensions.get('window').width} 
                    source={{html:this.props.route.params.data.id==0?qsg:this.props.route.params.data.id==1?faq:this.props.route.params.data.id==2?pp:null}} 
                    />
                </View>}                
                {
                    this.props.route.params.data.id==3&&<View>
                        <TextInputView
                            title={"Subject"}
