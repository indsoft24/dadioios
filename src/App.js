...
// import firebase from 'react-native-firebase';    //need to fix
import {
  DeviceEventEmitter,
  SafeAreaView,
  AppState,
...
// import {RNNotificationBanner} from 'react-native-notification-banner';   need to fix
...
export default class App extends React.Component {
  ...
  componentDidMount() {
    ...
    // this.checkPermission();   //need to fix
    // Register all listener for notification
    // this.createNotificationListeners();  //need to fix
  ...
  _handleAppStateChange = (nextAppState) => {
    ...
    if (
      ...
      console.log('src/App.js has come to the foreground!');
      this._updateUserStatus(0);
    }
    if (
